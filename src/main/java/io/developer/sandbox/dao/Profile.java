...
public class Profile {
    ...
    private static final String DELETE_FROM_PROFILE = "DELETE FROM profile WHERE userid = ?";
    ...
    public void delete(final String uuid) throws SQLException {
        try (Connection connection = dataSource.getConnection()) {
            ...
            try (PreparedStatement deleteFromProfile = connection.prepareStatement(DELETE_FROM_PROFILE)) {
